...
namespace Profil_Osobowosci
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\Maciek\Desktop\dfg\mbti_1.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"type",inputColumnName:@"type",addKeyValueAnnotationsAsText:false)      
                                    .Append(mlContext.MulticlassClassification.Trainers.TextClassification(labelColumnName: @"type", sentence1ColumnName: @"posts"))      
